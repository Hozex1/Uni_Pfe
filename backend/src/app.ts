...
import groupManagementRoutes from "./modules/pfe/group-management.routes";
import pfeRoutes from "./modules/pfe/pfe.routes";
import pfeAdminRoutes from "./modules/pfe/pfe-admin.routes";
...
app.use("/api/v1/pfe", pfeAdminRoutes);
