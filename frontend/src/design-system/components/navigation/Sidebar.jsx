...
const icons = {
  ...
  '/dashboard/admin/alerts': (
    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.34 4.317a15.103 15.103 0 013.32 0c1.348.145 2.431 1.25 2.566 2.6l.177 1.784a5.25 5.25 0 001.248 2.885l.934 1.098c1.177 1.384.192 3.516-1.62 3.516H7.034c-1.812 0-2.797-2.132-1.62-3.516l.934-1.098A5.25 5.25 0 007.596 8.7l.177-1.783c.135-1.35 1.218-2.455 2.567-2.6z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a2.25 2.25 0 002.25-2.25h-4.5A2.25 2.25 0 0012 18.75z" />
    </svg>
  ),
...
const SECTIONS = {
  ...
  '/dashboard/admin/alerts': 'sections.system',
};
